  ...
  const providerLabel = capabilitiesUnavailable
    ...
    : capabilities?.aiMode === 'Fake'
      ...
      : capabilities?.aiMode === 'OpenAI'
        ? capabilities.aiConfigured ? `OpenAI · clarify ${capabilities.clarificationModel} · plan ${capabilities.planningModel} · implement ${capabilities.implementationModel}` : 'OpenAI configuration required'
