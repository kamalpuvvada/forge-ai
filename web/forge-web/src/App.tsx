...
function App() {
  ...
  function startAnother() { setTask(null); setRepository(''); setRequirement(''); setAnswer(''); setCorrection(''); setCorrectionMode(false); setPlanCorrection(''); setPlanCorrectionMode(false); setPlanningFailure(null); setPlanningSnapshotStale(false); setError(null) }
